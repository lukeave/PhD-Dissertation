...
####--------- API Request for St Louis 1904 World's Fair --------####
...
## The base URL below is an advanced search for the phrase "world's fair" across all newspaper publications in 1904.
...
base_url <- "https://www.loc.gov/collections/chronicling-america/?c=100&dl=page&end_date=1904-12-31&ops=PHRASE&qs=world%27s+fair&searchType=advanced&start_date=1904-01-01&language=english&fo=json&sb=title_s"
