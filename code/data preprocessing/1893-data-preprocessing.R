...
####--------- API Request for Chicago 1893 World's Fair --------####
...
## The base URL below is an advanced search for the phrase "world's fair" across all newspaper publications in 1893.
...
base_url <- "https://www.loc.gov/collections/chronicling-america/?c=100&dl=page&end_date=1893-12-31&ops=PHRASE&qs=centennial-exhibition&searchType=advanced&start_date=1893-01-01&language=english&fo=json&sb=title_s"
