...
## The base URL below is an advanced search for the phrase "centennial exhibition" across all newspaper publications in 1876.
...
base_url <- "https://www.loc.gov/collections/chronicling-america/?c=100&dl=page&end_date=1876-12-31&ops=PHRASE&qs=centennial+exhibition&searchType=advanced&start_date=1876-01-01&language=english&fo=json&sb=title_s"
