...
####--------- API Request for New York 1939 World's Fair --------####
...
## The base URL below is an advanced search for the phrase "world's fair" across all newspaper publications between 1939 and 1940.
...
base_url <- "https://www.loc.gov/collections/chronicling-america/?c=100&dl=page&end_date=1940-12-31&ops=PHRASE&qs=world%27s+fair&searchType=advanced&start_date=1939-01-01&language=english&fo=json&sb=title_s"
