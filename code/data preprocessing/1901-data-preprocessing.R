...
####--------- API Request for Buffalo 1901 World's Fair --------####
...
## The base URL below is an advanced search for the phrase "world's fair" across all newspaper publications in 1901.
...
base_url <- "https://www.loc.gov/collections/chronicling-america/?c=100&dl=page&end_date=1901-12-31&ops=PHRASE&qs=pan-american&searchType=advanced&start_date=1901-01-01&language=english&fo=json&sb=title_s"
